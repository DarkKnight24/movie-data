...
public class MovieServiceImpl implements MovieService {
    ...
    public MovieDetailDto selectByPrimaryKey(Long movieId) {
        ...
        movieDetailDto
            .setCountryName(movieCountryService.selectByPrimaryKey(movieDetailDto.getMovieCountry()).getCountryName());
    ...
    @Override
    public List<Movie> selectByCinemaType(Long cinemaTypeId) {
        return movieMapper.selectByCinemaType(cinemaTypeId);
    }
}
